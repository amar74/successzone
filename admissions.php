<?php
   ...
   && isset($_POST['parent_name']) && isset($_POST['gen']) && isset($_POST['birth']) 
   && isset($_POST['stand']) && isset($_POST['our_institute']))
   {
	...
	$institute=$_POST['our_institute'];
	 ...
	 {		 
			...
			exit();
			 ...
			 $query="insert into admission_db values('$name','$number','$email', '$parentName', '$gender', '$dob', '$standard', '$institute',)";
